...
The docker on first run will download the current 0.1.13 version of `All the Mods 9 No frills` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
